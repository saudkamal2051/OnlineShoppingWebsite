...
public class SettingController {
 ...
 for(Setting setting : listSettings) {
	...
	public String saveGeneralSetting(@RequestParam("fileImage") MultipartFile 
			multipartFile ,HttpServletRequest request,RedirectAttributes ra) 
					throws IOException {
	...
	ra.addFlashAttribute("message", "Mail Server Setting Have Been SavedSuccessfully:");
	return "redirect:/settings";
	 }
	...
	ra.addFlashAttribute("message", "Mail Template Setting Have Been Saved Successfully:");
	return "redirect:/settings";
	 }
}
