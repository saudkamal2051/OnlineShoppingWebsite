...
@RestController
public class StateResControllerTests {
	...
	@Test
	@WithMockUser(username="nam@codejava.net" ,password = "kamal2020" ,roles ="ADMIN")
  ...
  State[] states =objectMapper.readValue(JsonRespone, State[].class);
